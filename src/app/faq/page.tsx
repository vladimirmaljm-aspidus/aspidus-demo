...
const faqs = [
  { q: "What is VELOS?", a: "VELOS is a multi-tenant trade CRM/ERP platform designed for international commodity trading houses. It handles everything from partner management and offers to invoices, trade calculations, document verification, and ERP/accounting." },
  ...
  { q: "Can I use my own currency?", a: "Yes. VELOS supports 50+ currencies with live exchange rates. Each cost line in a trade calculation can be in a different currency, and the system automatically converts to your base currency." },
  ...
  { q: "Do you offer API access?", a: "Yes. Business and Enterprise plans include full API access with 216 REST endpoints. You can integrate VELOS with your existing systems, create custom workflows, and automate trade processes." },
    ...
    <SiteChrome>
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p className="mt-4 text-lg text-muted-foreground">
          {t("faq.subtitle") || "Everything you need to know about VELOS."}
        </p>
