      ...
      <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 space-y-6 text-sm leading-relaxed text-muted-foreground">
          <div>
            ...
            <p className="mt-2">By using Aspidus, you agree to these terms. If you do not agree, do not use the service.</p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="mt-2">You agree not to use Aspidus for illegal activities, spam, or to store data that violates applicable laws. Each tenant is responsible for the accuracy of their trade data.</p>
          </div>
          <div>
            <h2 className="text-base font-semibold text-foreground">4. Limitation of Liability</h2>
            <p className="mt-2">Aspidus is provided "as is". We are not liable for indirect, incidental, or consequential damages arising from the use of the platform.</p>
          </div>
          <div>
            <h2 className="text-base font-semibold text-foreground">5. Contact</h2>
            <p className="mt-2">For legal questions, contact: desk@aspidus.co</p>
          </div>
        </div>
      </div>
    </SiteChrome>
